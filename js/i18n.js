...
const I18N_MY = {
  ...
  'Account permissions': 'အကောင့် ခွင့်ပြုချက်များ',
  'Total users': 'စုစုပေါင်း အသုံးပြုသူ',
  'Active accounts': 'အတည်ပြုပြီး အကောင့်များ',
  'Pending requests': 'စောင့်ဆိုင်းနေသော တောင်းဆိုချက်များ',
  'All accounts': 'အကောင့်အားလုံး',
  'Active (approved)': 'လက်ရှိသုံးနေသူများ (အတည်ပြုပြီး)',
  'Make Admin': 'အက်မင် သတ်မှတ်မည်',
  'Remove Admin': 'အက်မင် ဖယ်ရှားမည်',
  'Approve': 'အတည်ပြုမည်',
  'Reject': 'ငြင်းပယ်မည်',
  'Approve pending requests, or promote a user to admin.': 'စောင့်ဆိုင်းနေသော တောင်းခံမှုများကို အတည်ပြုပါ သို့မဟုတ် အသုံးပြုသူကို အက်မင် အဖြစ် မြှင့်တင်ပါ။',
  ...
  'Restore From Backup': 'Backup မှ ပြန်လည်ရယူမည်',
